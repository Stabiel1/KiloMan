...
export function Hair() {
  return (
    <group position={[0, 1.25, 0]}>
      ...
      {/* Front strands — left */}
      <mesh position={[-0.11, 0.06, 0.19]} rotation={[0, 0, 0.22]} castShadow>
      ...
      <mesh position={[-0.21, -0.08, 0.02]} rotation={[0, 0, 0.12]} castShadow>
        <boxGeometry args={[0.048, 0.42, 0.07]} />
        <meshStandardMaterial {...platinum} />
      </mesh>
      <mesh position={[-0.24, -0.22, -0.02]} rotation={[0.08, 0, 0.08]} castShadow>
